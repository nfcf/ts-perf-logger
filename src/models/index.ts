export { IPerfLogHandler } from './perflog-handler.interface';
export { IPerfLogMethod } from './perflog-method.interface';
export { Map } from './map.class';
export { PerfLog } from './perflog.class';
